...
from audioUnlearning.model import SaveMethods
...
model_history = TrainMethods.train_model(model,600, optimizer,X_train,y_train,X_test,y_test)
...
ConfusionMatrix.plot_confusion_matrix(y_test2,predicted_index)